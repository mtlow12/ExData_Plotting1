...
#Create 4 plots
par(mfrow = c(2, 2))
with(d, plot(d$datetime, d$Global_active_power, ylab = "Global Active Power", xlab="", pch=".", lines(d$datetime,d$Global_active_power)))
with(d, plot(d$datetime, d$Voltage, ylab = "Voltage", xlab="datetime", pch=".", lines(d$datetime,d$Voltage)))
...
with(d, plot(d$datetime, d$Global_reactive_power, ylab = "Global_reactive_power", xlab="datetime", pch=".", lines(d$datetime,d$Global_reactive_power)))
